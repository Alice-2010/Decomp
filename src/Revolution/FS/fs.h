    ...
    #include "Revolution/IPC.h" // IWYU pragma: export
    #include "Revolution/iosrestypes.h"
    #include "types.h"
    #ifdef __cplusplus
        extern "C" {
    #endif
    ...
    s32 ISFS_GetAttrAsync(const char* path, u32* ownerIdOut, u16* groupIdOut, u32* attrOut, u32* ownerPermOut, u32* groupPermOut, u32* otherPermOut, FSAsyncCallback callback, void* callbackArg);
    ...
    s32 ISFS_GetFileStatsAsync(IOSFd fd, ISFSFileStats* statsOut, FSAsyncCallback callback, void* callbackArg);
    s32 ISFS_Seek(IOSFd fd, s32 offset, IPCSeekMode mode);
    s32 ISFS_SeekAsync(IOSFd fd, s32 offset, IPCSeekMode mode, FSAsyncCallback callback, void* callbackArg);
    s32 ISFS_Read(IOSFd fd, void* dst, s32 len);
    s32 ISFS_ReadAsync(IOSFd fd, void* dst, s32 len, FSAsyncCallback callback, void* callbackArg);
    s32 ISFS_Write(IOSFd fd, const void* src, s32 len);
    s32 ISFS_WriteAsync(IOSFd fd, const void* src, s32 len, FSAsyncCallback callback, void* callbackArg);
