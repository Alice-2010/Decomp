#include "Revolution/IPC.h" // IWYU pragma: keep
#include "Revolution/OS.h" // IWYU pragma: keep
#include "PowerPC_EABI_Support/MSL/MSL_C/string.h" // IWYU pragma: keep
...
inline IPCRequestEx* ipcAllocReq(void) {
    return (IPCRequestEx*)iosAllocAligned(hid, sizeof(IPCRequestEx), 32);
}

inline s32 ipcFree(void* block) {
    iosFree(hid, block);
    return IPC_RESULT_OK;
}

inline s32 __ipcQueueRequest(IPCRequestEx* req) {
...
inline s32 __ipcSendRequest(void) {
    s32 ret = IPC_RESULT_OK;
    IPCRequestEx* req;
    s32 waiting;
...
inline void IpcAckHandler(u8 intr, OSContext* ctx) {
#pragma unused(intr)
#pragma unused(ctx)
...
inline s32 __ios_Ipc1(s32 fd, IPCRequestType type, IPCAsyncCallback callback, void* callbackArg, IPCRequestEx** out)
{
    IPCRequest* req;
    s32 ret = IPC_RESULT_OK;
...
//unused
inline void __ios_Ipc2WithTimeout() {}

//unused
inline void __timeout_cb() {}

inline s32 __ios_Open(IPCRequestEx* req, const char* path, IPCOpenMode mode)
{
    s32 ret = IPC_RESULT_OK;
...
//unused
inline void IOS_OpenWithTimeout() {}
...
//unused
inline void IOS_CloseWithTimeout() {}

inline s32 __ios_Read(IPCRequestEx* req, void* buf, s32 len) {
    s32 ret = IPC_RESULT_OK;
...
inline s32 __ios_Write(IPCRequestEx* req, const void* buf, s32 len) {
    s32 ret = IPC_RESULT_OK;
...
inline s32 __ios_Seek(IPCRequestEx* req, s32 offset, IPCSeekMode mode) {
    s32 ret = IPC_RESULT_OK;
...
inline s32 __ios_Ioctl(IPCRequestEx* req, s32 type, void* in, s32 inSize,
